...
to recover ;; define recovery from infection
  if Infectious [
    ...
    if random-float 1.0 < 0.05 and duration_infection > 10 [ ;; generate random recovary probability between 0 and 1, probability of recovary is less than 5% and can only recover after 9 days
